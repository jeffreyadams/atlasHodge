...
Here is the Hodge filtration on the spherical oscillator
representation of $Sp(4,\C)$. This is a ladder representation, with
K-types in a line of multiplicity one. The Hodge filtration is given
by the filtration on $U(\g)$, acting on the spherical vector.
